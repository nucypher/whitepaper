...
\begin{abstract}
    \kms~is a global, decentralized Key Management System that addresses the limitations of using consensus
    ...
    Unlike centralized encryption-as-a-service solutions, it doesn't require trusting a service provider.
...
\kms~is a blockchain-based encryption and access control management service.
It enables private data sharing between arbitrary number of participants in public and/or decentralized networks.
...
NuCypherKMS enables KMS as a service using a decentralized network and a native token to remove this trusted relationship

...
It requires a lot of careful design and testing, Ethereum Proof-of-Stake (Casper) protocol is facing this complexity now.
It could be very possible to just check correctness on the level of the encryption algorithm~\cite{Zhou2002}.
...
Also, for the use case of streaming media content, key scraping attack should be especially problematic.
...
valued in NKMS.
It is possible to make re-encryption keys linked to particular proxies in order to identify them quickly once they're leaked on the encryption

...
\title{[Draft] \kms: Decentralized key management system}
...
using proxy re-encryption as part of a hybrid cryptosystem that combines the efficiency of symmetric encryption with the convenience of public-key encryption.

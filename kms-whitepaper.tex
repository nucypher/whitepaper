...
\subsection{Correctness of computations}

\subsection{Security of re-encryption keys}

\subsection{Functionality and necessity}  % XXX
...
\subsection{Network effects and incentives}  % XXX
...
\subsection{Issuance mechanism}  % XXX

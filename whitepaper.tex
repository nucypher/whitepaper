...
\usepackage[breaklinks,pdftitle={NuCypher: a proxy re-encryption network to empower privacy in decentralized systems}, pdfauthor={Michael Egorov},colorlinks,urlcolor=blue,citecolor=darkgreen,linkcolor=darkblue]{hyperref}
\graphicspath{{pdf/}}
...
\title{\kms: A proxy re-encryption network to empower privacy in decentralized systems}
...
The mechanism by which we achieve this is \kms~Token (NU).
